    ...
    public partial class Import : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                else
                {
                    if (!Page.IsPostBack)
                    {
                        ...
                        parameterList.Add(new SqlParameter("@usage", "Import"));
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else if (txtSource.Text == null || txtCompany.Text == null)
                {
                ...
                else
                {
                    ...
                    parameterList.Add(new SqlParameter("@location", txtSource.Text));
